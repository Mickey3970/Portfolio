      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            <Coffee className="text-blue-400 w-8 h-8" />
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-blue-500 transition-all duration-300">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-blue-400">Quick & Personal</p>
              </div>
            </div>
            ...
            <a 
              ...
              className="w-full bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-blue-700 transition duration-300 transform hover:scale-105 text-center block"
            >
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-blue-400">Detailed Discussion</p>
              </div>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full border border-blue-600 text-blue-400 font-semibold py-3 px-6 rounded-lg hover:bg-blue-600 hover:text-white transition duration-300 transform hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed"
              >
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center space-x-6">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-gray-800 hover:bg-blue-600 border border-gray-700 hover:border-blue-500 rounded-full p-4 transition-all duration-300 transform hover:scale-110"
              aria-label="LinkedIn"
            >
